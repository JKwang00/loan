...
?>
        ...
        <script src="<?php echo G5_ADMIN_URL ?>/assets/libs/apexcharts/apexcharts.min.js"></script>

        <script src="<?php echo G5_ADMIN_URL ?>/assets/libs/selectize/js/standalone/selectize.min.js"></script>

        <!-- Dashboar 1 init js-->
        <script src="<?php echo G5_ADMIN_URL ?>/assets/js/pages/dashboard-1.init.js"></script>
