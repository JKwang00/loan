...
function check_menu($key, $no){
    global $menu, $auth_menu, $is_admin, $auth, $g5;
    
    if ($is_admin == 'super') return true;
    for($i=1; $i<count($menu[$key]); $i++)
    {
        if (array_key_exists($menu[$key][$i][0],$auth) && (strstr($auth[$menu[$key][$i][0]], 'r') || strstr($auth[$menu[$key][$i][0]], 'a')))
            return true;
    }
    return false;
}
...
function print_menu2($key, $no='')
{
    ...
    $str .= '<div class="collapse" id="'.$key.'"><ul class="nav-second-level">';
    for($i=1; $i<count($menu[$key]); $i++)
    {
        ...
        $str .= '<li><a href="'.$menu[$key][$i][2].'" class="'.$current_class.'"><i data-feather="calendar"></i><span> '.$menu[$key][$i][1].' </span></a></li>';
            ...
            <div class="navbar-custom">
                <div class="container-fluid">
                    <ul class="list-unstyled topnav-menu float-right mb-0">
                                ...
                                <div class="app-search-box dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-lg" id="search-dropdown">
                                        ...
                                        <div class="notification-list">
                                            ...
                                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                                <div class="media">
                                                    <img class="d-flex mr-2 rounded-circle" src="<?php echo G5_ADMIN_URL ?>/assets/images/users/user-2.jpg" alt="Generic placeholder image" height="32">
                                            ...
                                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                                <div class="media">
                                                    <img class="d-flex mr-2 rounded-circle" src="<?php echo G5_ADMIN_URL ?>/assets/images/users/user-5.jpg" alt="Generic placeholder image" height="32">
                                                    <div class="media-body">
                            ...
                            <div class="dropdown-menu dropdown-lg dropdown-menu-right">
                                ...
                                <div class="p-lg-1">
                                    <div class="row no-gutters">
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#">
                                                <img src="<?php echo G5_ADMIN_URL ?>/assets/images/brands/slack.png" alt="slack">
                                                <span>Slack</span>
                                            </a>
                                        </div>
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#">
                                                <img src="<?php echo G5_ADMIN_URL ?>/assets/images/brands/github.png" alt="Github">
                                                <span>GitHub</span>
                                            </a>
                                        </div>
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#">
                                                <img src="<?php echo G5_ADMIN_URL ?>/assets/images/brands/dribbble.png" alt="dribbble">
                                                <span>Dribbble</span>
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row no-gutters">
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#">
                                                <img src="<?php echo G5_ADMIN_URL ?>/assets/images/brands/bitbucket.png" alt="bitbucket">
                                                <span>Bitbucket</span>
                                            </a>
                                        </div>
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#">
                                                <img src="<?php echo G5_ADMIN_URL ?>/assets/images/brands/dropbox.png" alt="dropbox">
                                                <span>Dropbox</span>
                                            </a>
                                        </div>
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#">
                                                <img src="<?php echo G5_ADMIN_URL ?>/assets/images/brands/g-suite.png" alt="G Suite">
                                                <span>G Suite</span>
                                            </a>
                                        </div>
                        ...
                        <li class="dropdown d-none d-lg-inline-block topbar-dropdown">
                            <a class="nav-link dropdown-toggle arrow-none waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                <img src="<?php echo G5_ADMIN_URL ?>/assets/images/flags/us.jpg" alt="user-image" height="16">
                            </a>
                            <div class="dropdown-menu dropdown-menu-right">
    
                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item">
                                    <img src="<?php echo G5_ADMIN_URL ?>/assets/images/flags/germany.jpg" alt="user-image" class="mr-1" height="12"> <span class="align-middle">German</span>
                                </a>
    
                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item">
                                    <img src="<?php echo G5_ADMIN_URL ?>/assets/images/flags/italy.jpg" alt="user-image" class="mr-1" height="12"> <span class="align-middle">Italian</span>
                                </a>
    
                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item">
                                    <img src="<?php echo G5_ADMIN_URL ?>/assets/images/flags/spain.jpg" alt="user-image" class="mr-1" height="12"> <span class="align-middle">Spanish</span>
                                </a>
    
                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item">
                                    <img src="<?php echo G5_ADMIN_URL ?>/assets/images/flags/russia.jpg" alt="user-image" class="mr-1" height="12"> <span class="align-middle">Russian</span>
                                </a>
                                ...
                                <div class="noti-scroll" data-simplebar>
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item notify-item active">
                                        <div class="notify-icon">
                                            <img src="<?php echo G5_ADMIN_URL ?>/assets/images/users/user-1.jpg" class="img-fluid rounded-circle" alt="" /> </div>
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        <div class="notify-icon">
                                            <img src="<?php echo G5_ADMIN_URL ?>/assets/images/users/user-4.jpg" class="img-fluid rounded-circle" alt="" /> </div>
                        ...
                        <li class="dropdown notification-list topbar-dropdown">
                            <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                <img src="<?php echo G5_ADMIN_URL ?>/assets/images/users/user-1.jpg" alt="user-image" class="rounded-circle">
                    ...
                    <!-- LOGO -->
                    <div class="logo-box">
                        <a href="<?php echo correct_goto_url(G5_ADMIN_URL); ?>" class="logo logo-dark text-center">
                            <span class="logo-sm">                                
                                <!-- <span class="logo-lg-text-light">UBold</span> -->
                            </span>
                            <span class="logo-lg">
                                <img src="<?php echo G5_ADMIN_URL ?>/assets/images/logo-dark.png" alt="" height="20">
                                <!-- <span class="logo-lg-text-light">U</span> -->
                            </span>
                        </a>
    
                        <a href="<?php echo correct_goto_url(G5_ADMIN_URL); ?>" class="logo logo-light text-center">
                            <span class="logo-sm">
                                <span class="logo-lg-text-light">ADM</span>
                            </span>
                            <span class="logo-lg">
            ...
            <div class="left-side-menu">
                ...
                <div class="h-100" data-simplebar>
                    ...
                    <div class="user-box text-center">
                        <img src="<?php echo G5_ADMIN_URL ?>/assets/images/users/user-1.jpg" alt="user-img" title="Mat Helme"
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul id="side-menu">
                            ...
                            foreach($amenu as $key=>$value) {
                                ...
                                if( check_menu('menu'.$key, 1) ){ //권한체크 추가
                                    
                                    $subCnt = count($menu['menu'.$key]);
                                    $target = $subCnt > 0 ? "#menu{$key}" : $menu['menu'.$key][0][2];
                            ?>
                            <li>
                                <a href="<?php echo $target ?>" data-toggle="collapse">
                                    <i class="<?php echo $menu['menu'.$key][0][3];?>"></i>
